window.addEventListener("DOMContentLoaded", () => {
  const people = [
    ...
    { name: "Arya Akeno Manggala", image: "img/Akeno.png", description: "Founder" },
    ...
    { name: "Ilham Bakti Pratama", image: "https://github.com/victorveroi/Portofolio-Kebersamaan/blob/main/Testweb/img/Ilham.jpg", description: "Member" },
